...
# add-on by Richard Schweitzer: get sample-to-sample directions
vecdir <- function(x,SAMPLING=500,TYPE=2) {
  v <- vecvel(x,SAMPLING,TYPE)
  deg <- atan2(v[,2], v[,1])*180/pi # larger y mean downward !
